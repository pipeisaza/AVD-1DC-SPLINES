...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF2 | Vlan4094 | 10.91.250.136 | Port-Channel7 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 |  dc1-leaf2-server1_iLO | access | 12 | - | - | - |
| Ethernet5 | dc1-leaf2-server1_PCI2 | *trunk | *11-12 | *11 | *- | 5 |
| Ethernet7 | MLAG_PEER_DC1-LEAF2A_Ethernet7 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 7 |
| Ethernet8 | MLAG_PEER_DC1-LEAF2A_Ethernet8 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 7 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet4 | routed | - | 10.91.250.21/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet4 | routed | - | 10.91.250.23/31 | default | 1500 | False | - | - |
...
| Port-Channel7 | MLAG_PEER_DC1-LEAF2A_Po7 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.91.250.70/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.91.250.101/32 |
| Loopback10 | VRF10_VTEP_DIAGNOSTICS | VRF10 | 10.91.192.6/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.91.250.70/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 10.91.250.101/32
!
interface Loopback10
   description VRF10_VTEP_DIAGNOSTICS
   no shutdown
   vrf VRF10
   ip address 10.91.192.6/32
```
...
| Vlan3009 |  VRF10  |  10.91.250.169/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.91.250.169/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.91.250.137/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- |
| 10.91.250.20 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.91.250.22 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.91.250.168 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
| 10.91.250.168 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 10.91.250.70:10011 | 10011:10011 | - | - | learned |
| 12 | 10.91.250.70:10012 | 10012:10012 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF10 | 10.91.250.70:10 | connected |
...
router bgp 65102
   ...
   neighbor 10.91.250.20 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.91.250.20 remote-as 65100
   neighbor 10.91.250.20 description DC1-SPINE1_Ethernet4
   neighbor 10.91.250.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.91.250.22 remote-as 65100
   neighbor 10.91.250.22 description DC1-SPINE2_Ethernet4
   neighbor 10.91.250.168 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.91.250.168 description DC1-LEAF2A
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 11
      rd 10.91.250.70:10011
      route-target both 10011:10011
      redistribute learned
   !
   vlan 12
      rd 10.91.250.70:10012
...
```eos
!
ip address virtual source-nat vrf VRF10 address 10.91.192.6
```
