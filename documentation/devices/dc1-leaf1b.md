...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF1 | Vlan4094 | 10.91.250.128 | Port-Channel7 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | dc1-leaf1-server1_PCI2 | *trunk | *11-12 | *11 | *- | 5 |
| Ethernet7 | MLAG_PEER_dc1-leaf1a_Ethernet7 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 7 |
| Ethernet8 | MLAG_PEER_dc1-leaf1a_Ethernet8 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 7 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet2 | routed | - | 10.91.250.5/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet2 | routed | - | 10.91.250.7/31 | default | 1500 | False | - | - |
...
| Port-Channel7 | MLAG_PEER_dc1-leaf1a_Po7 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
router bgp 65101
   ...
   neighbor 10.91.250.4 description dc1-spine1_Ethernet2
   ...
   neighbor 10.91.250.160 description dc1-leaf1a
