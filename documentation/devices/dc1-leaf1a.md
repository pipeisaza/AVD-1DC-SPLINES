...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF1 | Vlan4094 | 10.91.250.129 | Port-Channel7 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet4 |  dc1-leaf1-server1_iLO | access | 11 | - | - | - |
| Ethernet5 | dc1-leaf1-server1_PCI1 | *trunk | *11-12 | *11 | *- | 5 |
| Ethernet7 | MLAG_PEER_dc1-leaf1b_Ethernet7 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 7 |
| Ethernet8 | MLAG_PEER_dc1-leaf1b_Ethernet8 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 7 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet1 | routed | - | 10.91.250.1/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet1 | routed | - | 10.91.250.3/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | dc1-leaf1-server1_PortChannel dc1-leaf1-server1 | switched | trunk | 11-12 | 11 | - | - | - | 5 | - |
| Port-Channel7 | MLAG_PEER_dc1-leaf1b_Po7 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
router bgp 65101
   ...
   neighbor 10.91.250.2 description dc1-spine2_Ethernet1
   ...
   neighbor 10.91.250.161 description dc1-leaf1b
