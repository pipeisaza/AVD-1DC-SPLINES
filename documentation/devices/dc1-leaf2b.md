...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF2 | Vlan4094 | 10.91.250.132 | Port-Channel7 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet4 | routed | - | 10.91.250.13/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet4 | routed | - | 10.91.250.15/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.91.250.72/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.91.250.103/32 |
| Loopback10 | VRF10_VTEP_DIAGNOSTICS | VRF10 | 10.91.192.8/32 |
...
| Vlan3009 |  VRF10  |  10.91.250.165/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.91.250.165/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.91.250.133/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- |
| 10.91.250.12 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.91.250.14 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
...
| 10.91.250.164 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
| 10.91.250.164 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 10.91.250.72:10011 | 10011:10011 | - | - | learned |
| 12 | 10.91.250.72:10012 | 10012:10012 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF10 | 10.91.250.72:10 | connected |
...
router bgp 65102
   ...
   neighbor 10.91.250.12 description dc1-spine1_Ethernet4
   neighbor 10.91.250.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.91.250.14 remote-as 65100
   neighbor 10.91.250.14 description dc1-spine2_Ethernet4
   ...
   neighbor 10.91.250.164 description dc1-leaf2a
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 11
      rd 10.91.250.72:10011
      route-target both 10011:10011
      redistribute learned
   !
   vlan 12
      rd 10.91.250.72:10012
...
```eos
!
ip address virtual source-nat vrf VRF10 address 10.91.192.8
```
